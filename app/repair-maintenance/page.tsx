            ...
            <ul className="space-y-3 sm:space-y-4">
              ...
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-base text-gray-600">雨天记得给车座套上防水套，特别注意仪表盘和电池仓要做好防水。长期露天停放建议购买防晒防雨的车衣。</p>
                </div>
              </li>
              <li className="flex items-start">
                <Wrench className="w-4 h-4 sm:w-6 sm:h-6 text-blue-500 mr-1.5 sm:mr-2 mt-0.5 sm:mt-1 flex-shrink-0" />
                <div>
                  ...
                  <p className="text-xs sm:text-base text-gray-600">每学期至少做一次全面检修（约300-500元），包括更换刹车片、调整链条松紧度、检查电机等。遇到异响或操控不适要及时去维修点检查。定期给链条上油可以延长使用寿命。</p>
                </div>
              </li>
              <li className="flex items-start">
                <Wrench className="w-4 h-4 sm:w-6 sm:h-6 text-blue-500 mr-1.5 sm:mr-2 mt-0.5 sm:mt-1 flex-shrink-0" />
                <div>
                  ...
                  <p className="text-xs sm:text-base text-gray-600">冬季温度低，要特别注意：电池预热后再骑行，避免冷启动；路面结冰时谨慎骑行，保持低速；长时间不用时将电池取下室内保管；做好防寒保暖，戴手套骑行。</p>
                </div>
              </li>
            </ul>
          </div>
