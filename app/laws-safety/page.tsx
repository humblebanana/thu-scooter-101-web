          ...
          <div className="bg-white rounded-lg p-6 shadow-md">
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold">电动车进入校园规定</h3>
                  <p className="text-gray-600">自2021年11月1日起，禁止未悬挂正规号牌的电动自行车进入校园。未持有电子标签的电动自行车禁止进入学生生活区。</p>
                </div>
              </li>
              <li className="flex items-start">
                <Shield className="w-6 h-6 text-blue-500 mr-2 mt-1" />
                <div>
                  <h3 className="font-semibold">骑行规则</h3>
                  <p className="text-gray-600">校园内限速15公里/小时，避让行人和自行车，禁止鸣笛噪音，禁止边行驶边使用手机，提倡骑行时佩戴安全头盔。</p>
                </div>
              </li>
              <li className="flex items-start">
                <Shield className="w-6 h-6 text-blue-500 mr-2 mt-1" />
                <div>
                  <h3 className="font-semibold">充电管理</h3>
                  <p className="text-gray-600">电动自行车及电池不得进入所有教学、科研、办公场所和学生公寓。未经学校审核批准，不得私自建设和运行电动车充电设施。</p>
                </div>
              </li>
              <li className="flex items-start">
                <Shield className="w-6 h-6 text-blue-500 mr-2 mt-1" />
                <div>
                  <h3 className="font-semibold">违规处理</h3>
                  <p className="text-gray-600">对违反相关规定和拒不服从管理的情况，学校将采取提醒劝阻、登记记录、挪移车辆并集中停放等措施，并追究相关责任。</p>
                </div>
              </li>
            </ul>
          </div>
